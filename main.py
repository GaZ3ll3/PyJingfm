...
class JingFM:
    def __init__(self, email, passwd):
        ...
        self.resp_create = requests.post(url_create, data=json.dumps(payload), headers=init_headers,
                                         params=self.params_create)
    ...
    def fetch_track_infos(self):
        ...
        for i in xrange(self.limit):
            ...
            self.resp_fetch_track_infos = requests.post(url_fetch_track_infos, headers=self.headers,
                                                        params=self.params_fetch_track_infos).content
